...
$priceforperson=$_POST['priceforperson'];
...
$sql = sprintf("UPDATE `advertisment` SET `name`='$name',`description`='$description',`priceforperson`='$priceforperson',`foodpriceforperson`='$foodpriceforperson',`startdate`='$startdate',`finishdate`='$finishdate' WHERE id = %d", $id);
$connect->query($sql); 
            ...
            <div class="container">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">
                        <li>
                            <a href="advertisment_admin.php">Wróć do ofert</a>
                        </li>
                        <li>
    ...
    <section id="success">
        <div class="container">
            ...
            <div class="center">
                ...
                <br><br>
                <h5>Dane oferta zostały zaktualizowane.</h5>
                <br><br>
                <a href="advertisment_admin.php" class="waves-effect waves-light btn-large"><i class="material-icons left">check</i>Przejdź do listy ofert</a>
            </div>
            <br><br>
        </div>
    </section>
