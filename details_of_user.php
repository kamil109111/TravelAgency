...
<body>
    ...
    <body id="home" class="scrollspy">
        ...
        <section id="details" class="section section-contact scrollspy">
            <div class="container">
                <div class="row">
                    <h4 class="center"><span class="teal-text">Szczegóły</span> Użytkownika</h4>
                    <div class="col s12 m12">
                        ...
                        <ul class="collection white-header">
                            ...
                            <li class="collection-item">ID użytkownika: <?php echo $id?></li>
                            <li class="collection-item">Login: <?php echo $login?></li>
                            <li class="collection-item">E-mail: <?php echo $email ?></li>
                            <li class="collection-item">Telefon: <?php echo $phone ?></li>                            
                        </ul>
                    </div>                    
                </div>
            </div>
