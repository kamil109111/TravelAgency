...
$sql = sprintf("UPDATE `orders` SET `first_date`='$date1',`second_date`='$date2',`persons`='$persons',`food`='$food',`overall`='$overall' WHERE id = %d", $id);
$connect->query($sql); 
    ...
    <section id="success">
        <div class="container">
            ...
            <div class="center">
                ...
                <br><br>
                <h5>Dane zamówienia zostały zaktualizowane.</h5>
                <br><br>
                <a href="orders_admin.php" class="waves-effect waves-light btn-large"><i
                        class="material-icons left">check</i>Wróć do listy ofert</a>
            </div>
            <br><br>
        </div>
    </section>
