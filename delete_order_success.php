...
$sql = sprintf("DELETE FROM orders WHERE id = %d", $pid);
$connect->query($sql);
    ...
    <section id="success">
        <div class="container">
            ...
            <div class="center">
                ...
                <br><br>
                <h5>Zamówienie zostało usunięte z bazy danych.</h5>
                <br><br>
                <a href="orders_admin.php" class="waves-effect waves-light btn-large"><i class="material-icons left">check</i>Przejdź do listy zamówień</a>
            </div>
            <br><br>
        </div>
    </section>
