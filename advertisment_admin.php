            ...
            <div class="row">
                <div class="col s12">
                    ...
                    <div class="input-field">
                        <form action="advertisment_admin.php" method="post">
                            <input type="text" name="valueToSearch" class="white grey-text autocomplete"
                                id="autocomplete-input" placeholder="Egipt, Hiszpania, itp...">
    ...
    <section id="advert" class="section section-popular scrollspy">
        <div class="container">
            <div class="row">
                ...
                <!--Nagłówek sekcji-->
                <h4 class="center"><span class="teal-text">Zarządzaj</span> Ofertami</h4>
