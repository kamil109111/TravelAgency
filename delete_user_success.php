...
$sql = sprintf("DELETE FROM users WHERE id = %d", $pid);
$connect->query($sql);
    ...
    <section id="success">
        <div class="container">
            ...
            <div class="center">
                ...
                <br><br>
                <h5>Użytkownik został usunięty z bazy danych.</h5>
                <br><br>
                <a href="users_admin.php" class="waves-effect waves-light btn-large"><i class="material-icons left">check</i>Przejdź do listy użytkowników</a>
            </div>
            <br><br>
        </div>
    </section>
