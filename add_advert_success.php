    ...
    <section id="success">
        <div class="container">
            ...
            <div class="center">
                ...
                <br><br>
                <h5>Nowa oferta została dodana do bazy danych.</h5>
                <br><br>
                <a href="advertisment_admin.php" class="waves-effect waves-light btn-large pulse"><i class="material-icons left">check</i>Przejdź do listy ofert</a>
            </div>
            <br><br>
        </div>
    </section>
