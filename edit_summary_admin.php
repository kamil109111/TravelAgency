...
$query = "select * from `advertisment` where `id` = '$ad_id'";
    ...
    <body id="home" class="scrollspy">
        ...
        <section id="summary">
            <div class="container">
                ...
                <form action="edit_success_admin.php" method="post">
                    ...
                    <div class="center">
                        <input type="submit" class="waves-effect waves-light btn-large" value="Potwierdź" />
                    </div>
                </form>
